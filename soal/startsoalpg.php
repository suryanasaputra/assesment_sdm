...
<html lang="en">
  ...
  <body>
        ...
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="startsoalpg.php"><img alt="Brand" src="../assets/img/tvip.png" width="30"></a>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="startsoaldisc.php">Test 2</a></li>
                    <li><a href="startsoalmbti.php">Test 3</a></li>
                    <li><a href="startsoalketelitian1.php">Test 4</a></li>
                    <li><a href="startsoalketelitian2.php">Test 5</a></li>
                    <li role="separator" class="divider"></li>
          ...
          <div id="kontenku">
              <div class="row">
                  ...
                  <div class="alert alert-warning alert-dismissible text-center" role="alert">
                    ...
                    <strong>Instruksi : </strong> Soal dan Jawaban akan tampil secara acak. Setiap jawaban yang benar maka anda akan mendapat point 1. <br>
                    Membutuhkan waktu <strong>15 menit</strong>. <br>Silahkan klik <strong>START</strong> untuk memulai.
                  </div>
                    <br>
    ...
    <script>
     <?php if(isset($_SESSION["mulai_kuis"])) : ?>
      mulai();
     <?php endif; ?>

      function mulai() {
        $('#kontenku').load('ajax/soalpg.php');
      }
      function soaljawab() {
