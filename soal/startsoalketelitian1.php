...
<html lang="en">
  ...
  <body>
        ...
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="startsoalketelitian1.php"><img alt="Brand" src="../assets/img/tvip.png" width="30"></a>
                ...
                <p><strong>TEST 3</strong></p>
                 <div class="alert alert-warning alert-dismissible text-center" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">&times;</span></button>
                      ...
                      <br>Pada test ini anda diwajibkan untuk  mencocokan urutan angka yang ada pada soal dibawah ini. Sebagai contoh jika menurut anda urutan angka tersebut sama persis maka silahkan pilih B (Benar). Jika menurut anda urutan angka berbeda satu sama lain maka silahkan pilih S (Salah).  <br>Silahkan klik <strong>START</strong> untuk memulai.
                  </div>
                <br>
    ...
    // <?php if(isset($_SESSION["mulai_kuis_ketelitian1"]) && isset($_SESSION["mulai_ketelitian1"]) == false) : ?>
      mulai();
      
    // <?php endif; ?>

      function mulai() {
        $('#kontenku').load('ajax/soalketelitian1.php');
      }
      function soaljawab() {
