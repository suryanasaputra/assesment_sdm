...
<html lang="en">
  ...
  <body>
        ...
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="startsoalmbti.php"><img alt="Brand" src="../assets/img/tvip.png" width="30"></a>
                  ...
                  <div class="col-sm-12 text-center">
                    ...
                    <div class="alert alert-warning alert-dismissible text-center" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                          ...
                          <br>Pilihlah pernyataan yang menurut anda paling sesuai dengan diri anda yang tersedia di samping pernyataan tersebut</strong>. <br>Silahkan klik <strong>START</strong> untuk memulai.
                    </div>  
                    <br>
    ...
    <script>
    //<?php if(isset($_SESSION["mulai_kuis_mbti"]) && isset($_SESSION["mulai_mbti"]) == false) : ?>
      mulai();
    <?php endif; ?>

      function mulai() {
        $('#kontenku').load('ajax/soalmbti.php');
      }
      function soaljawab() {
