...
<html lang="en">
  ...
  <body>
        ...
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="startsoaldisc.php"><img alt="Brand" src="../assets/img/tvip.png" width="30"></a>
              ...
              <div class="row">
                  ...
                  <div class="col-sm-12 text-center">
                    ...
                    <div class="alert alert-warning alert-dismissible text-center" role="alert">
                      ...
                      <br>Mulailah dengan membayangkan kondisi yang anda pilih untuk diresponi, contoh "Rumah", "Kantor", atau "Sosial". Setiap soal terdapat empat pernyataan, dan hanya bisa dipilih salah satu. Kemudian pilih pernyataan tersebut yang "MENDEKATI" (M) atau "TIDAK MENDEKATI" (L) pada diri anda. <br>Silahkan klik <strong>START</strong> untuk memulai.
                    </div>
                    <br>
    ...
    <script>
    // <?php if(isset($_SESSION["mulai_kuis_profile"]) && isset($_SESSION["mulai_profile"]) == false) : ?>
      mulai();
    // <?php endif; ?>

      function mulai() {
        $('#kontenku').load('ajax/soaldisc.php');
      }
      function soaljawab() {
